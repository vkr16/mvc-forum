...
class Notification_model
{
	...
	public function saveNotification($lcid, $c_username, $d, $powner, $a)
	{
		...
		$this->db->query('INSERT INTO notifications (comment_id,sender_username,sender_photo,recipient,post_id,time_notified) VALUES (:comment_id,:sender_username,:sender_photo,:notif_recipient,:post_id,:time_notified)');
		...
		$this->db->bind('time_notified', $now);
		$this->db->execute();
