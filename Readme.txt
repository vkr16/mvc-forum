...
# Start Configuration
    ...
    1. Change database configuration on file "app/config/config.php" 
				a. Change http://localhost/mvc-forum to your working directory on local or your link to the root of your host 
				b. Change "localhost" on DB_HOST to your database host
				c. Change "root" on DB_USER to your database username
				d. Change "" (empty quotation mark) on DB_PASS to your database password
				e. Change "openforum" on DB_NAME to your database name

    2. Change static link for ajax on file "app/views/login/index.php" and file "app/views/register/index.php"
				a. Locate "http://localhost/mvc-forum" and replace your working directory on local or your link to the root of your host 
